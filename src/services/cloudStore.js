...
const toAppParcel = (parcel) => {
  ...
  return {
    ...
    recipientName: parcel.recipientName ?? parcel.recipient_name ?? '',
    recipientIdNo: parcel.recipientIdNo ?? parcel.recipient_id_no ?? '',
    recipientRole: parcel.recipientRole ?? parcel.recipient_role ?? 'student',
...
const toDbParcel = (parcel) => ({
  ...
  recipient_id_no: parcel.recipientIdNo ?? '',
  recipient_role: parcel.recipientRole ?? 'student',
